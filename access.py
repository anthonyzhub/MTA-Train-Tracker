...
class Access:
    ...
    def __init__(self) -> None:
        ...
        self.g_train_api = "https://api-endpoint.mta.info/Dataservice/mtagtfsfeeds/nyct%2Fgtfs-g"
        self.numeric_trains_api = "https://api-endpoint.mta.info/Dataservice/mtagtfsfeeds/nyct%2Fgtfs"

        # Define URL header
        self.header = {"x-api-key": "sB7SvouzMO7aFRBGFyP9j4c47KREip1185sxNJVL"}
